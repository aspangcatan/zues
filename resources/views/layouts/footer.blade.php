<footer class="bg-black text-white py-8">
    <div class="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="text-center md:text-left mb-4 md:mb-0">
            <p class="text-sm text-[#D99D07] mt-2">
        ...
        <div class="flex space-x-6">
            ...
            <a href="https://www.instagram.com" target="_blank" class="text-[#D99D07] hover:text-[#FFC5C5] transition">
                <i class="fab fa-instagram text-3xl"></i>
            </a>
            <a href="https://www.linkedin.com" target="_blank" class="text-[#D99D07] hover:text-[#FFC5C5] transition">
                <i class="fab fa-linkedin-in text-3xl"></i>
            </a>
            <a href="https://www.youtube.com" target="_blank" class="text-[#D99D07] hover:text-[#FFC5C5] transition">
