    ...
    <div id="teamSlider" class="flex transition-transform duration-500">
        ...
        <div class="team-member w-[300px] flex-shrink-0 text-center border-2 border-gold-500 p-6 rounded-lg shadow-lg hover:shadow-gold-500 transition duration-300">
            <div class="w-56 h-56 bg-gray-300 mx-auto rounded-lg overflow-hidden">
                <img src="{{ asset('img/Love.jpg') }}" alt="Asnaui Pangcatan" class="w-full h-full object-cover">
            </div>
            <p class="mt-4 text-lg font-semibold text-gold-500">LOVE</p>
        ...
        <div class="team-member w-[300px] flex-shrink-0 text-center border-2 border-gold-500 p-6 rounded-lg shadow-lg hover:shadow-gold-500 transition duration-300">
            <div class="w-56 h-56 bg-gray-300 mx-auto rounded-lg overflow-hidden">
                <img src="{{ asset('img/Pau.jpg') }}" alt="Jobeth Adjaluddin" class="w-full h-full object-cover">
            </div>
            <p class="mt-4 text-lg font-semibold text-gold-500">PAU</p>
        ...
        <div class="team-member w-[300px] flex-shrink-0 text-center border-2 border-gold-500 p-6 rounded-lg shadow-lg hover:shadow-gold-500 transition duration-300">
            <div class="w-56 h-56 bg-gray-300 mx-auto rounded-lg overflow-hidden">
                <img src="{{ asset('img/Ronie.jpg') }}" alt="Klaire Lee" class="w-full h-full object-cover">
            </div>
            <p class="mt-4 text-lg font-semibold text-gold-500">RONIE</p>
        ...
        <div class="team-member w-[300px] flex-shrink-0 text-center border-2 border-gold-500 p-6 rounded-lg shadow-lg hover:shadow-gold-500 transition duration-300">
            <div class="w-56 h-56 bg-gray-300 mx-auto rounded-lg overflow-hidden">
                <img src="{{ asset('img/Tess.jpg') }}" alt="Rey Arki" class="w-full h-full object-cover">
            </div>
            <p class="mt-4 text-lg font-semibold text-gold-500">TESS</p>
            {{-- <p class="text-sm text-gray-300 italic">Event Coordinator</p> --}}
        </div>
    </div>
</div>
